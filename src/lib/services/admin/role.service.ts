...
export const roleService = {
    ...
    getRolesWithPermissions: () => 
        api.get<ApiResponse<RoleWithPermissions[]>>('/admin/roles/all'),
     ...
     */
    getRole: (id: number) => 
        api.get<ApiResponse<RoleWithPermissions>>(`/admin/roles/${id}`),
    ...
    deleteRole: (id: number) => 
        api.delete<ApiResponse<null>>(`/admin/roles/${id}`),
     ...
     */
    getPermissions: () => 
        api.get<ApiResponse<string[]>>('/admin/roles/permissions'),
};