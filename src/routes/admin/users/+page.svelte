                        ...
                        <Table.Row>
                            ...
                            <Table.Cell class="text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <Button variant="ghost" size="icon" class="text-destructive hover:text-destructive" onclick={() => openDeleteAlert(user)}>
        ...
        <AlertDialog.Content>
            <AlertDialog.Header>
                ...
                <AlertDialog.Description>
                    Tindakan ini tidak dapat dibatalkan. Pengguna <strong>{userToDelete?.name}</strong> akan dihapus permanen dari sistem.
                </AlertDialog.Description>
            </AlertDialog.Header>
            <AlertDialog.Footer>
